    ...
    <div class="card" >
            ...
            <div class="card-footer text-muted">
              <div class="row row-cols-3">
                <div class="col"><strong class="Rating"></strong>${movie.rating}</div>
                <div class="col"><strong class="Rated"></strong>${movie.rated}</div>
                <div class="col"><strong class="Votes"></strong>${movie.votes}</div>
